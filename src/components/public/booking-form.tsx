...
export default function BookingForm() {
  ...
  const selectSuggestion = (suggestion: Suggestion) => {
    ...
    if (!customerName || customerName.trim() === '') {
        form.setError('customerName', { type: 'manual', message: 'El nombre es requerido para agendar.' });
        return;
    }
    ...
    toast({
      title: '¡Cita Agendada!',
      description: `Gracias, ${newAppointment.customerName}. Tu cita para el ${format(newAppointment.start, "eeee, d 'de' MMMM 'a las' HH:mm", { locale: es })} ha sido agendada.`,
    });
    
    resetForm();
    form.reset(); // Full reset after booking
  };
      ...
      <form className="space-y-8">
        {step === 1 && (
          <div className="space-y-4">
            <h3 className="text-lg font-medium text-center">Paso 1: Elige el servicio y la fecha</h3>
        ...
        {step === 2 && (
          <div className="space-y-4">
              <h3 className="text-lg font-medium text-center">Paso 2: Confirma los detalles</h3>
              <FormField
                control={form.control}
                name="customerName"
                render={({ field }) => (
              ...
              />
            <h4 className="text-md font-medium text-center pt-4">Horarios Sugeridos por la IA</h4>
